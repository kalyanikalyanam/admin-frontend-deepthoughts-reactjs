...
//     console.log(_id);
//     axios
//       .get(`https://deepthoughts-nodejs.herokuapp.com/home/update_home1/${_id}`)
//       .then((res) => {
...
//       axios
//         .put(
//           `https://deepthoughts-nodejs.herokuapp.com/home/update_home1_patch/${_id}`,
//           formdata
//         )
...
class EditHome1 extends React.Component {
  ...
  handleSubmit(e) {
    ...
    if (this.validator.allValid()) {
      ...
      axios
        .put(
          `https://deepthoughts-nodejs.herokuapp.com/home/update_home1_patch/608b912efcc7860015dce5b1`,
          menu
        )
        .then((res) => console.log(res.data));
